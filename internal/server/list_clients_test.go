...
type mockProDeputyHubClientInformation struct {
	count            int
...
func (m *mockProDeputyHubClientInformation) GetProDeputyDetails(ctx sirius.Context, deputyId int) (sirius.ProDeputyDetails, error) {
	m.count += 1
	m.lastCtx = ctx
...
func (m *mockProDeputyHubClientInformation) GetDeputyClients(ctx sirius.Context, deputyId int, columnBeingSorted string, sortOrder string) (sirius.DeputyClientDetails, sirius.AriaSorting, error) {
	m.count += 1
	m.lastCtx = ctx
...
func TestNavigateToClientTab(t *testing.T) {
	...
	client := &mockProDeputyHubClientInformation{}
